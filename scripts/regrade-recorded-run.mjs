...
const sourceRunPath = path.join(evaluationDir, "recorded-run-2026-08-07T18-31-55-434Z.json");
const auditedRunPath = path.join(evaluationDir, "audited-run-rubric-v2.json");
...
const auditedRun = {
  ...sourceRun,
  runId: `${sourceRun.runId}-audited-rubric-v2`,
